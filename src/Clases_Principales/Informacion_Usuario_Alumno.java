 ...
 * @author aleja
 */
public class Informacion_Usuario_Alumno extends javax.swing.JFrame {

    /**
     * Creates new form Informacion_Administrativo_general
     */
    public Informacion_Usuario_Alumno() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes_del_Registro_Escolar/Informacion de usuario alumno.PNG"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 70, 580, 320);
        ...
        Color_de_fondo.setBounds(0, 60, 610, 360);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Informacion_Usuario_Alumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Informacion_Usuario_Alumno().setVisible(true);
            }
        });
    }
